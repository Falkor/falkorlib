...
# Time-stamp: <Jeu 2015-01-22 09:06 svarrette>
#
...
describe FalkorLib::Bootstrap do
    ...
    #############################################################
    context "Test bootstrapping operations within temporary directory " do

        it "#trash - create a trash dir on a non-git directory" do
